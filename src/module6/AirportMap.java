...
public class AirportMap extends PApplet {
	...
	public void setup() {
		...
		// list for markers, hash map for quicker access when matching with routes
		...
		for(PointFeature feature : features) {
			...
			// put airport in hash map with OpenFlights unique id for key
		...
		for (Marker m : airportList) {
			...
			if (!marker.isHidden() && marker.isInside(map, mouseX, mouseY)) {
				...
				for (Marker route : routeList) {
					...
					//if (!route.getLocations().equals(lastClicked.getLocation())) {
