...
public class EarthquakeCityMap extends PApplet {
	...
	*/
	...
	{  
	    ...
	    // an float that represents the size of the marker
	    float small = (float)5.0;
	    float medium = (float)10.0;
	    float large = (float)15.0;
		...
		// TODO (Step 4): Add code above to style the marker's size and color 
	...
	// TODO: Implement this method to draw the key (Describing the markers, 
	//explain what they stand for
	//display them to the left of the map) 
	private void addKey() {	
		fill(255, 255, 255);
		rect(25, 50, 150, 250);
		fill(0, 0, 0);
