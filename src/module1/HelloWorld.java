...
public class HelloWorld extends PApplet
{
	...
	/** The map you will use to display your home town: Escondido, CA */ 
	UnfoldingMap map2;

	public void setup() {
		size(900, 600);  // Set up the Applet window to be 800x600
		...
		map2.zoomAndPanTo(zoomLevel, new Location(33.1f, -117.1f));
