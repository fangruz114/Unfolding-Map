	...
	private void printQuakes() 
	{
		...
		for (Marker cm: countryMarkers) {
			...
			for (Marker eq: quakeMarkers) {
				...
				if (em.isOnLand) {
					if ((String)cm.getProperty("name") == (String)eq.getProperty("country")) {
						quakeCounter++;
					}
				}
				else {
		...
		System.out.println("Earthquakes in the Ocean: " + oceanCounter);
